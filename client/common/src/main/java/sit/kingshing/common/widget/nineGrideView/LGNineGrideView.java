...
public class LGNineGrideView extends ViewGroup {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int defaultSpace = (int) Ui.dipToPx(context.getResources(), DEFAULT_SPACING);
        ...
        singleImageMode = typedArray.getInteger(R.styleable.LGNineGrideView_singleImageRatioMode, SINGLE_IMAGE_MODE_RELATIVE_TO_SELF);
